                    ...
                    <Card className="sticky top-8 shadow-md">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="space-y-3">
                                <div className="flex justify-between items-center">
                                    <div>
                                        ...
                                        <p className="text-2xl font-bold text-teal-600">
                                            ₹
                                            {pkg.pricePerAdult.toLocaleString(
                                                "en-IN",
                                            )}
                                        </p>
                                    </div>
                                    <div className="text-right">
                                        ...
                                        <p className="text-2xl font-bold text-gray-800">
                                            ₹
                                            {pkg.pricePerChild.toLocaleString(
                                                "en-IN",
                                            )}
                                        </p>
                                    </div>
                                ...
                                <div className="rounded-lg bg-amber-50 border border-amber-200 p-3">
                                    <p className="text-xs text-amber-800">
                                        ...
                                        ₹
                                        {pkg.minBookingAmount.toLocaleString(
                                            "en-IN",
                                        )}{" "}
                                        per person to confirm. Pay the rest
                                        later.
                                    </p>
                                </div>
                            </div>
                            ...
                            <p className="text-xs text-center text-gray-400">
                                No hidden charges. Free cancellation up to 48hrs
                                before travel.
                            </p>
                        </CardContent>
                    </Card>
